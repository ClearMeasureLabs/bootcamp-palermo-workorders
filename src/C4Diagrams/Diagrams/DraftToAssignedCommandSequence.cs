...
public class DraftToAssignedCommandSequence : SequenceDiagram
{
    protected override string Title => "DraftToAssignedCommand Sequence";
    ...
    [
        ...
        It("api") > It("bus") | "Send(DraftToAssignedCommand)",
        It("bus") > It("mediator") | "Send(DraftToAssignedCommand)",
        It("mediator") > It("cmdHandler") | "Handle(StateCommandBase)",
        It("cmdHandler") > It("cmd") | "Execute(StateCommandContext)",
        It("cmd") > It("order") | "AssignedDate = CurrentDateTime",
        It("cmd") > It("order") | "ChangeStatus(CurrentUser, date, Assigned)",
        It("cmdHandler") > It("db") | "SaveChangesAsync()",
        It("cmdHandler") > It("mediator") | ("StateCommandResult", "Assign")
    ];
}
