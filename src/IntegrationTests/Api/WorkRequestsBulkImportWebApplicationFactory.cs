...
/// </summary>
public sealed class WorkRequestsBulkImportWebApplicationFactory : WebApplicationFactory<UiServerWebApplicationMarker>
{
    internal const string SqliteConnectionString = "Data Source=work-requests-bulk-import;Mode=Memory;Cache=Shared";
