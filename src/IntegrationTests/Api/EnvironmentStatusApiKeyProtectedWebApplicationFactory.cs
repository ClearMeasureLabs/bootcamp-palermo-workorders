...
/// <summary>
/// Same as <see cref="EnvironmentStatusWebApplicationFactory"/> with API-key middleware enabled.
/// </summary>
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, config) =>
        {
            config.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["EnvironmentDiagnostics:VariableNames:0"] = EnvironmentStatusWebApplicationFactory.TestEnvironmentVariableName,
