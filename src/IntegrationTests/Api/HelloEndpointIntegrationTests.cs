...
public class HelloEndpointIntegrationTests
{
    ...
    {
        using var anonymousClient = _factory!.CreateClient(new Microsoft.AspNetCore.Mvc.Testing.WebApplicationFactoryClientOptions
        {
            AllowAutoRedirect = false
        });

        var response = await anonymousClient.GetAsync("/api/hello");
