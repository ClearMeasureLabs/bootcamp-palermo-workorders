...
public class HelloEndpointIntegrationTests
{
    ...
    [Test]
    public async Task Should_Return200AndPlainTextHello_When_GetUnversioned()
    {
    ...
    [Test]
    public async Task Should_Return200AndPlainTextHello_When_GetVersioned()
    {
    ...
    public async Task Should_Return200WithoutApiKey_When_HelloAndMiddlewareEnabled()
    {
        ...
        (await unversioned.Content.ReadAsStringAsync()).ShouldBe("Hello");

        var versioned = await client.GetAsync("/api/v1.0/hello");
        versioned.StatusCode.ShouldBe(HttpStatusCode.OK);
        (await versioned.Content.ReadAsStringAsync()).ShouldBe("Hello");
    }
}
