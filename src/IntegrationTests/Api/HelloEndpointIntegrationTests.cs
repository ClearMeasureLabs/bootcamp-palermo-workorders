...
public class HelloEndpointIntegrationTests
{
    ...
    [Test]
    public async Task Should_Return200WithJsonMessage_When_GetHelloEndpoint()
    {
    ...
    [Test]
    public async Task Should_Return200WithJsonMessage_When_GetVersionedHelloEndpoint()
    {
    ...
    [Test]
    public async Task Should_NotRequireApiKey_When_CallingHelloEndpoint()
    {
