...
public class HelloEndpointIntegrationTests
{
    ...
    [Test]
    public async Task Should_Return200WithJsonHelloWorld_When_GetUnversioned()
    {
    ...
    [Test]
    public async Task Should_Return200WithJsonHelloWorld_When_GetVersioned()
    {
    ...
    public async Task Should_Return200WithoutApiKey_When_HelloAndMiddlewareEnabled()
    {
        ...
        JsonSerializer.Deserialize<HelloResponse>(unversionedBody, ConditionalGetEtag.JsonSerializerOptions)!
        ...
        JsonSerializer.Deserialize<HelloResponse>(versionedBody, ConditionalGetEtag.JsonSerializerOptions)!
            .Message.ShouldBe("Hello, World!");
    }
}
