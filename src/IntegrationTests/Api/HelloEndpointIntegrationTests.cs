...
public class HelloEndpointIntegrationTests
{
    ...
    public async Task Should_Return200AndJsonHelloMessage_When_GetUnversioned()
    {
        ...
        var payload = JsonSerializer.Deserialize<HelloMessageResponse>(
    ...
    public async Task Should_Return200WithoutApiKey_When_HelloAndMiddlewareEnabled()
    {
        ...
        var unversionedPayload = JsonSerializer.Deserialize<HelloMessageResponse>(
        ...
        var versionedPayload = JsonSerializer.Deserialize<HelloMessageResponse>(
