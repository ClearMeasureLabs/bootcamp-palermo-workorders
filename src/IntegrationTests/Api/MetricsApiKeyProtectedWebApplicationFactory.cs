...
/// <summary>
/// Same as <see cref="MetricsWebApplicationFactory"/> with API key protection enabled.
/// </summary>
public sealed class MetricsApiKeyProtectedWebApplicationFactory : WebApplicationFactory<UiServerWebApplicationMarker>
{
