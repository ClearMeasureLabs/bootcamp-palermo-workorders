...
public class McpWorkOrderToolTests
{
    ...
    public async Task ShouldGetWorkOrderByNumber()
    {
        ...
        var order = new WorkOrder
        {
            ...
            Instructions = "Use a wrench and turn off water first",
            RoomNumber = "101"
        };
        ...
        result.ShouldContain("Use a wrench and turn off water first");
    ...
    public async Task ShouldCreateDraftWorkOrder()
    {
        ...
        var result = await WorkOrderTools.CreateWorkOrder(bus, numberGenerator, "New Work Order", "Fix the broken window", "creator1", "Wear gloves", "101");
