...
public class ZDataLoader
{
    ...
    private void LoadSimpsonsChurchData()
    {
        ...
        // christmasOrder1.RoomNumber = "Sanctuary"; // Removed - using new Rooms collection
        ...
        // christmasOrder2.RoomNumber = "Exterior Grounds"; // Removed - using new Rooms collection
        ...
        // christmasOrder3.RoomNumber = "Sanctuary Organ Loft"; // Removed - using new Rooms collection
        ...
        // christmasOrder4.RoomNumber = "Sanctuary"; // Removed - using new Rooms collection
        ...
        // christmasOrder5.RoomNumber = "Sanctuary"; // Removed - using new Rooms collection
        ...
        // christmasOrder6.RoomNumber = "Church Office"; // Removed - using new Rooms collection
