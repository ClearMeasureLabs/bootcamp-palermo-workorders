...
public class ZDataLoader
{
    ...
    private void LoadSimpsonsChurchData()
    {
        ...
        christmasOrder1.Title = "Choir Practice";
        ...
        christmasOrder2.Title = "Church Grounds";
        ...
        christmasOrder3.Title = "Tune Organ";
        ...
        christmasOrder4.Title = "Setup Audio Sys";
        ...
        christmasOrder5.Title = "Christmas Tree";
        ...
        christmasOrder6.Title = "Program Design";
