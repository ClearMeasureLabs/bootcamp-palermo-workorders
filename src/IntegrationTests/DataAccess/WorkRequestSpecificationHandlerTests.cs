...
[TestFixture]
public class WorkRequestSpecificationHandlerTests
{
    [Test]
    public void ShouldHandleRemotedQuery()
    {
        new WorkRequestSpecificationQuery();
    }
    ...
    public async Task ShouldSearchBySpecificationWithAssignee()
    {
        ...
        var repository = new WorkRequestSearchHandler(dataContext);
    ...
    public async Task ShouldSearchWithEmptySpecificationAndReturnAll()
    {
        ...
        var dataContext = TestHost.GetRequiredService<DataContext>();
        var repository = new WorkRequestSearchHandler(dataContext);
        var orders = await repository.Handle(new WorkRequestSpecificationQuery());
