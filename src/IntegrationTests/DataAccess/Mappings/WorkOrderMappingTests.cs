...
public class WorkOrderMappingTests
{
    ...
    public void ShouldPersistInstructionsField()
    {
        ...
        var workOrder = new WorkOrder
        {
            ...
            Instructions = "Please use the ladder in the storage room and bring safety goggles",
            RoomNumber = "101",
            Creator = creator,
            Status = WorkOrderStatus.Draft
        };
        ...
        rehydratedWorkOrder.Instructions.ShouldBe("Please use the ladder in the storage room and bring safety goggles");
    }
