...
public class WorkOrderMappingTests
{
    ...
    public void ShouldPersistInstructionsField()
    {
        ...
        var workOrder = new WorkOrder
        {
            ...
            Instructions = "Follow these specific instructions carefully",
            Creator = creator,
            Status = WorkOrderStatus.Draft
        };
        ...
        rehydratedWorkOrder.Instructions.ShouldBe("Follow these specific instructions carefully");
    }
    ...
    public void ShouldPersistInstructionsWithMaxLength()
    {
        ...
        var workOrder = new WorkOrder
        {
            ...
            Description = "Testing Instructions field with max length",
