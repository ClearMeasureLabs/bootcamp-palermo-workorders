...
public class WorkOrderMappingTests
{
    ...
    public void ShouldMapWorkOrderBasicProperties()
    {
        ...
        var workOrder = new WorkOrder
        {
            ...
            Instructions = "Use LED bulbs only",
            RoomNumber = "CR-101",
        ...
        rehydratedWorkOrder.Instructions.ShouldBe("Use LED bulbs only");
    ...
    public void ShouldPersistInstructionsField()
    {
        ...
        var creator = new Employee("creator1", "John", "Doe", "john@example.com");
        var instructions = "Please ensure all safety protocols are followed. Wear protective gear.";
        var workOrder = new WorkOrder
        {
            Number = "WO-07",
            Title = "Safety Test",
