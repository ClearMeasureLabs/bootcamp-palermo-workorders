...
public class WorkOrderMappingTests
{
    ...
    [Test]
    public void ShouldMapWorkOrderInstructionsField()
    {
        new DatabaseTests().Clean();
        ...
        var workOrder = new WorkOrder
        {
            ...
            Instructions = "Please follow safety protocols when performing this work",
            RoomNumber = "CR-102",
            Status = WorkOrderStatus.Draft,
            Creator = creator
        };
        ...
        rehydratedWorkOrder.Instructions.ShouldBe("Please follow safety protocols when performing this work");
    }

    [Test]
    public void ShouldSaveWorkOrderWithEmptyInstructions()
    {
        new DatabaseTests().Clean();
    ...
    [Test]
    public void ShouldSaveWorkOrderWith4000CharacterInstructions()
    {
        new DatabaseTests().Clean();
