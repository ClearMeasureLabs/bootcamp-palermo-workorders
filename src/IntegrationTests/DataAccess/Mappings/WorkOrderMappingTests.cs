...
public class WorkOrderMappingTests
{
    ...
    public void ShouldPersistInstructionsWithMaxLength()
    {
        ...
        {
            Number = "WO-07",
            Title = "Test Instructions Max Length",
            Description = "Testing that Instructions field can hold 4000 characters",
    ...
    [Test]
    public void ShouldPersistWorkOrderWithEmptyInstructions()
    {
        new DatabaseTests().Clean();
        ...
        var workOrder = new WorkOrder
        {
            ...
            Description = "Testing that Instructions field can be empty",
            Instructions = "",
            Creator = creator,
            Status = WorkOrderStatus.Draft
        };
