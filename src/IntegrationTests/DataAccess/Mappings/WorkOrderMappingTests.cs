...
public class WorkOrderMappingTests
{
    ...
    public void ShouldMapInstructionsProperty()
    {
        ...
        var workOrder = new WorkOrder
        {
            ...
            Instructions = "Please follow safety protocols when working on this task",
            RoomNumber = "CR-101",
            Status = WorkOrderStatus.Draft,
            Creator = creator
        };
        ...
        rehydratedWorkOrder.Instructions.ShouldBe("Please follow safety protocols when working on this task");
    }
