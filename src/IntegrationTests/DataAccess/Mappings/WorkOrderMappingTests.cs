...
public class WorkOrderMappingTests
{
    ...
    public void ShouldMapWorkOrderBasicProperties()
    {
        ...
        var workOrder = new WorkOrder
        {
            ...
            Instructions = "Use LED bulbs, ensure power is off before starting",
            RoomNumber = "CR-101",
        ...
        rehydratedWorkOrder.Instructions.ShouldBe("Use LED bulbs, ensure power is off before starting");
    ...
    public async Task ShouldSaveWorkOrder()
    {
        ...
        var order = new WorkOrder
        {
            ...
            Title = "foo",
            Description = "bar",
            Instructions = "Follow safety procedures",
            RoomNumber = "123 a"
        };
