...
public class WorkOrderMappingTests
{
    ...
    [Test]
    public void ShouldMapWorkOrderWithBlankInstructions()
    {
        new DatabaseTests().Clean();
        ...
        {
            Number = "WO-07",
            Title = "Test Blank Instructions",
            Description = "Testing blank instructions field",
            Instructions = null,
            Creator = creator,
            Status = WorkOrderStatus.Draft
        };
    ...
    [Test]
    public void ShouldMapWorkOrderWithMaxLengthInstructions()
    {
        new DatabaseTests().Clean();
