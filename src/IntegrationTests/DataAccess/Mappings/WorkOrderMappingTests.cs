...
public class WorkOrderMappingTests
{
    ...
    public void ShouldMapWorkOrderBasicProperties()
    {
        ...
        var workOrder = new WorkOrder
        {
            ...
            Instructions = "Use ladder carefully and turn off power first",
            RoomNumber = "CR-101",
        ...
        rehydratedWorkOrder.Instructions.ShouldBe("Use ladder carefully and turn off power first");
    ...
    public void ShouldSaveWorkOrderWithEmptyInstructions()
    {
        ...
        var workOrder = new WorkOrder
        {
            ...
            Description = "Testing that Instructions can be empty",
            Instructions = null,
            Creator = creator,
            Status = WorkOrderStatus.Draft
        };
    ...
    public void ShouldSaveWorkOrderWith4000CharacterInstructions()
    {
        ...
        var workOrder = new WorkOrder
        {
            ...
            Description = "Testing that Instructions can be 4000 characters",
