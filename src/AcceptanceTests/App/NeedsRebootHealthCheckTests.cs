...
/// <summary>
/// Uses a process-wide static flag on the server; must not run in parallel with other tests
/// that call the same demo endpoints or the flag is reset by another test's tear-down.
/// </summary>
[TestFixture]
[NonParallelizable]
