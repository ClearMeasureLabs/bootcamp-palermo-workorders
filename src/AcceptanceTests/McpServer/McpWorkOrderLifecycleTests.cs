...
public class McpWorkOrderLifecycleTests : McpAcceptanceTestBase
{
    ...
    public async Task ShouldCompleteFullLifecycleViaDirectToolCalls()
    {
        ...
        var createResult = await CallToolDirectly("create-work-order",
        ...
        var workOrderNumber = ExtractJsonValue(createResult, "Number");
        workOrderNumber.ShouldNotBeNullOrEmpty("Work order number should be returned");

        // Step 2: Assign the work order (Draft -> Assigned)
        var assignResult = await CallToolDirectly("execute-work-order-command",
            new Dictionary<string, object?>
            {
        ...
        var beginResult = await CallToolDirectly("execute-work-order-command",
            new Dictionary<string, object?>
            {
                ["workOrderNumber"] = workOrderNumber,
        ...
        var completeResult = await CallToolDirectly("execute-work-order-command",
            new Dictionary<string, object?>
            {
                ["workOrderNumber"] = workOrderNumber,
        ...
        var getResult = await CallToolDirectly("get-work-order",
            new Dictionary<string, object?>
            {
                ["workOrderNumber"] = workOrderNumber
            });
    ...
    public async Task ShouldAssignAndCancelViaDirectToolCalls()
    {
        ...
        await CallToolDirectly("execute-work-order-command",
            new Dictionary<string, object?>
            {
                ["workOrderNumber"] = workOrderNumber,
                ["commandName"] = "DraftToAssignedCommand",
        ...
        var cancelResult = await CallToolDirectly("execute-work-order-command",
            new Dictionary<string, object?>
            {
                ["workOrderNumber"] = workOrderNumber,
    ...
    public async Task ShouldBeginAndShelveViaDirectToolCalls()
    {
        ...
        var shelveResult = await CallToolDirectly("execute-work-order-command",
            new Dictionary<string, object?>
            {
                ["workOrderNumber"] = workOrderNumber,
