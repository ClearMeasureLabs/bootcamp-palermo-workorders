...
/// </summary>
public static class WorkRequestBulkImportCsvParser
{
    ...
    /// </summary>
    public static WorkRequestBulkImportParseResult Parse(Stream stream, CancellationToken cancellationToken = default)
    {
    ...
    internal static WorkRequestBulkImportParseResult Parse(TextReader reader, CancellationToken cancellationToken = default)
    {
        var lineNumber = 0;
        string? headerLine = ReadLogicalLine(reader, ref lineNumber, cancellationToken);
        if (headerLine == null)
        {
            return WorkRequestBulkImportParseResult.Fail("CSV is empty.");
        }
        ...
        foreach (var required in RequiredHeaders)
        {
            ...
            {
                return WorkRequestBulkImportParseResult.Fail(
        ...
        var rows = new List<WorkRequestBulkImportRow>();
        while (true)
        {
            ...
            rows.Add(new WorkRequestBulkImportRow(
                lineNumber,
                Cell(titleIx),
                Cell(descIx),
                Cell(creatorIx),
        ...
        return WorkRequestBulkImportParseResult.Ok(rows);
    }
