...
/// <summary>
/// Enforces an optional shared API key on <c>/api/*</c> routes, excluding public version, time, ping, and quote endpoints.
/// </summary>
    ...
    internal static bool IsPublicVersionOrTimePath(string pathValue)
    {
        ...
        if (segments.Length == 2)
        {
            ...
            return leaf.Equals("version", StringComparison.OrdinalIgnoreCase)
                   ...
                   || leaf.Equals("quote", StringComparison.OrdinalIgnoreCase);
        }
