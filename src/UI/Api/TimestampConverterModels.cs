...
/// <param name="Iso8601">ISO-8601 round-trip (<c>O</c> format, invariant culture).</param>
/// <param name="UtcFormatted">Human-readable UTC timestamp (invariant culture).</param>
/// <param name="LocalFormatted">Human-readable local timestamp using the server time zone (invariant culture).</param>
