...
public class WorkOrderTests
{
    ...
    [Test]
    public void Should_SetInstructionsToEmptyWhenNull()
    {
        var order = new WorkOrder();
    ...
    [Test]
    public void Should_AcceptExactly4000CharactersInInstructions()
    {
        var exactText = new string('x', 4000);
        var order = new WorkOrder();
        order.Instructions = exactText;
        Assert.That(order.Instructions.Length, Is.EqualTo(4000));
        Assert.That(order.Instructions, Is.EqualTo(exactText));
    }
