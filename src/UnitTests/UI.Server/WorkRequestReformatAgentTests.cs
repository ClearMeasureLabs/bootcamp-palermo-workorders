...
[TestFixture]
public class WorkRequestReformatAgentTests
{
    [Test]
    public void ShouldParseResponseWithTitleAndDescription()
    {
        var workRequest = new WorkRequest { Title = "old title", Description = "old description" };
        var responseText = "TITLE: New Title\nDESCRIPTION: New description with proper grammar.";

        var result = WorkRequestReformatAgent.ParseResponse(responseText, workRequest);
    ...
    {
        var workRequest = new WorkRequest { Title = "Same title", Description = "Same description" };
    ...
    {
        var workRequest = new WorkRequest { Title = "lowercase title", Description = "Good description." };
    ...
    {
        var workRequest = new WorkRequest { Title = "Good Title", Description = "bad grammar here" };
    ...
    {
        var workRequest = new WorkRequest { Title = "Original Title", Description = "old desc" };
    ...
    {
        var workRequest = new WorkRequest { Title = "old title", Description = "Original Description" };
    ...
    {
        var workRequest = new WorkRequest { Title = "test", Description = "test" };
    ...
    {
        var workRequest = new WorkRequest { Title = "My Title", Description = "My Description" };
    ...
    {
        var workRequest = new WorkRequest { Title = "old", Description = "old" };
