...
public class MainLayoutTests
{
    ...
    [Test]
    public void ShouldRenderTerminalReadyNote_InFooter()
    {
        using var ctx = CreateContext();
        ...
        var note = layout.Find($"[data-testid='{nameof(MainLayout.Elements.TerminalReady)}']");
        note.TextContent.Trim().ShouldBe("Terminal ready");
    }
