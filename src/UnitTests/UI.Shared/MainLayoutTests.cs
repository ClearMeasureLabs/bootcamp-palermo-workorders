...
public class MainLayoutTests
{
    ...
    [Test]
    public void ShouldRenderBatchNote3_InFooter()
    {
        using var ctx = CreateContext();
        ...
        var note = layout.Find($"[data-testid='{nameof(MainLayout.Elements.BatchNote3)}']");
        note.TextContent.Trim().ShouldBe("Batch note 3");
    }
