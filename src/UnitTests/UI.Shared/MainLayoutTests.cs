...
public class MainLayoutTests
{
    ...
    [Test]
    public void ShouldRenderBatchNote9_InFooter()
    {
        using var ctx = CreateContext();
        ...
        var batchNote = layout.Find($"[data-testid='{nameof(MainLayout.Elements.BatchNote9)}']");
        batchNote.TextContent.Trim().ShouldBe("Batch note 9");
    }
