...
public class MainLayoutTests
{
    ...
    [Test]
    public void ShouldRenderBatchNote2_InFooter()
    {
        using var ctx = CreateContext();
        ...
        var note = layout.Find($"[data-testid='{nameof(MainLayout.Elements.BatchNote2)}']");
        note.TextContent.Trim().ShouldBe("Batch note 2");
    }
