...
[TestFixture]
public class WorkRequestManageSpeechTests
{
    [Test]
    public void ShouldRenderSpeakTitleButton()
    {
        ...
        {
            var element = component.Find($"[data-testid='{WorkRequestManage.Elements.SpeakTitle}']");
    ...
    public void ShouldRenderSpeakDescriptionButton()
    {
        ...
        component.WaitForAssertion(() =>
        {
            var element = component.Find($"[data-testid='{WorkRequestManage.Elements.SpeakDescription}']");
            element.ShouldNotBeNull();
            element.TagName.ShouldBe("BUTTON", StringCompareShould.IgnoreCase);
            element.GetAttribute("type").ShouldBe("button");
        });
    ...
    public void SpeakTitleButtonShouldInvokeTranslationService()
    {
        ...
        component.WaitForAssertion(() =>
        {
            var titleInput = component.Find($"[data-testid='{WorkRequestManage.Elements.Title}']");
            titleInput.ShouldNotBeNull();
        });

        // Set the title value
        var titleElement = component.Find($"[data-testid='{WorkRequestManage.Elements.Title}']");
        titleElement.Change("Test title");

        var speakButton = component.Find($"[data-testid='{WorkRequestManage.Elements.SpeakTitle}']");
        speakButton.Click();
