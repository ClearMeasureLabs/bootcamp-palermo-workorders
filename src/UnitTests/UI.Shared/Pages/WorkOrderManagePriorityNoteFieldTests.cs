...
[TestFixture]
public class WorkOrderManagePriorityNoteFieldTests
{
    [Test]
    public async Task WorkOrderManage_ShouldRenderPriorityNoteAsTextareaWithMaxLength200()
    {
        ...
        var priorityNote = await component.WaitForElementAsync(
            $"[data-testid='{WorkOrderManage.Elements.PriorityNote}']");
        priorityNote.TagName.ShouldBe("TEXTAREA");
        priorityNote.GetAttribute("maxlength").ShouldBe(WorkOrder.PriorityNoteMaxLength.ToString());
    }
