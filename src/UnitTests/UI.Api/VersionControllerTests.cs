...
public class VersionControllerTests
{
    ...
    public void Get_Should_ReturnOk_WithExpectedShape()
    {
        ...
        var expectedConfiguration = typeof(VersionController).Assembly.GetCustomAttribute<AssemblyConfigurationAttribute>()?.Configuration;
        payload.Configuration.ShouldBe(expectedConfiguration);
        expectedConfiguration.ShouldNotBeNullOrEmpty();
