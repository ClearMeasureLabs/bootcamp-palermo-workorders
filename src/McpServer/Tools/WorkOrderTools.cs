...
public class WorkOrderTools
{
    ...
    [McpServerTool(Name = "create-work-order"), Description("Creates a new draft work order. Requires a title, description, and the username of the creator. Optionally accepts instructions (execution notes) and a room number for the location.")]
    public static async Task<string> CreateWorkOrder(
        ...
        [Description("Optional instructions for executing the work order")] string? instructions = null,
