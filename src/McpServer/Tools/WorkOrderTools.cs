...
public class WorkOrderTools
{
    ...
    [McpServerTool(Name = "create-work-order"), Description("Creates a new draft work order. Requires a title, description, and the username of the creator. Optionally accepts a room number for the location and instructions for the assignee.")]
    public static async Task<string> CreateWorkOrder(
        ...
        [Description("Optional instructions for the assignee")] string? instructions = null)
    {
        try
        {
