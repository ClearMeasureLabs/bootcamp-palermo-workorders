...
public class WorkOrderTools
{
    ...
    [McpServerTool(Name = "create-work-order"), Description("Creates a new draft work order. Requires a title, description, and the username of the creator. Optionally accepts instructions (up to 4000 characters) and a room number for the location.")]
    public static async Task<string> CreateWorkOrder(
        ...
        [Description("Optional instructions for fulfilling the work order (max 4000 characters)")] string? instructions = null,
