...
public class WorkRequestEndpoint : ClearHostedEndpoint
{
    private const string EndpointName = "WorkRequestProcessing";
    private const string SchemaName = "nServiceBus";

    public WorkRequestEndpoint(IConfiguration configuration) : base(configuration)
    {
        EndpointOptions = new()
        {
