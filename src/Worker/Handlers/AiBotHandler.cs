...
public class AiBotHandler : IHandleMessages<WorkRequestAssignedToBotEvent>
{
    public Task Handle(WorkRequestAssignedToBotEvent message, IMessageHandlerContext context)
    {
