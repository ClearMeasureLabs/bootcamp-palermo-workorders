...
public class WorkRequestAttachmentMap : IEntityFrameworkMapping
{
    public void Map(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<WorkRequestAttachment>(entity =>
        {
            entity.ToTable("WorkRequestAttachment", "dbo");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Id).IsRequired().ValueGeneratedNever();
            entity.Property(e => e.WorkRequestId).IsRequired();
