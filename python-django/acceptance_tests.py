...
try:
    ...
    employee = Employee.objects.create(username="acceptance-tech", email="acceptance-tech@example.test", first_name="Casey", last_name="Tech")
    ...
    timothy = Employee.objects.create(username="tlovejoy", email="tlovejoy@example.test", first_name="Timothy", last_name="Lovejoy")
    ...
    with sync_playwright() as p:
        ...
        page.get_by_label("Assignee").select_option(label="Timothy Lovejoy")
