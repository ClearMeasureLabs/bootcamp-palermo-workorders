...
export ConnectionStrings__SqlConnectionString='server=127.0.0.1;database=ChurchBulletin_7164_serve;User ID=sa;Password=IbmBob-mssql#Dev1;TrustServerCertificate=true;'
export AI_OpenAI_ApiKey=''
export AI_OpenAI_Url=''
export AI_OpenAI_Model=''
cd '/workspace/src/UI/Server'
exec dotnet run --no-launch-profile --urls http://0.0.0.0:8080
