...
& $crapAudit -Threshold 15 -SkipTests -FailOnViolations
if ($LASTEXITCODE -ne 0) {
    throw "CRAP gate failed: in-scope production methods exceed threshold 15. See crap-metrics/crap-production-violations.json"
}