	...
	return (
		<AbsoluteFill style={{backgroundColor: '#0b1420', overflow: 'hidden'}}>
			...
			<AbsoluteFill style={{justifyContent: 'flex-end', alignItems: 'flex-start'}}>
				...
				>
					<div style={{fontFamily: 'Segoe UI, Arial, sans-serif', fontWeight: 800, fontSize: 34, color: 'white'}}>
						{heading}
					</div>
					<div style={{fontFamily: 'Segoe UI, Arial, sans-serif', fontWeight: 400, fontSize: 22, color: 'rgba(255,255,255,0.85)', marginTop: 6}}>
						{detail}
					</div>
				</div>
			</AbsoluteFill>
