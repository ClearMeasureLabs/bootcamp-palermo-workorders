...
| Playwright NUnit browser tests, `AcceptanceTests.ps1 -Headful` | Playwright for Java + JUnit 5; browser installation via Playwright CLI; headful mode via `headless=false` | The browser acceptance test creates and assigns a work order, checks instructions persistence and urgency badge display, and records video; Java CI and Remotion MP4 rendering passed in [run #35923838044](https://github.com/ClearMeasureLabs/bootcamp-palermo-workorders/actions/runs/35923838044) |
