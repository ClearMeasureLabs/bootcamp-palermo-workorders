...
var org = args.Contains("--org") ? args[Array.IndexOf(args, "--org") + 1] : "";
var repo = args.Contains("--repo") ? args[Array.IndexOf(args, "--repo") + 1] : "";
...
if (readyCount > 0)
{
    ...
    Console.WriteLine();
    Console.WriteLine("Run: cd .bob/skills/ai-factory-executor && dotnet run");
}
else
{
